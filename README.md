...
### Описание
Проект RecipeSavor - это "продуктовый помощник". В этом сервисе авторизованные пользователи могут публиковать свои рецепты,
...
* Склонировать данный репозиторий `git clone git@github.com:mxstrv/recipesavor-project.git`
