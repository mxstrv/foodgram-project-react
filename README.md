...
### Описание
Проект Foodgram - это "продуктовый помощник". В этом сервисе авторизованные пользователи могут публиковать свои рецепты,
подписываться на рецепты других пользователей и добавлять понравивщиеся рецепты в список «Избранное», из которого затем можно будет
сформировать список покупок в формате pdf-файла.
...
* Склонировать данный репозиторий `git clone git@github.com:mxstrv/foodgram-project-react.git`
* Заполнить .env файл в соответствии с примером
* Запустить `docker compose -f docker-compose-production.yml --build`
